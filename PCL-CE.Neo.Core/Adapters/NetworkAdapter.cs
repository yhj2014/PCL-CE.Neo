...
public class SimpleWebServer : IWebServer
{
    ...
    public event Action<IWebServerRequest, Action<IWebServerResponse>>? RequestReceived;
    ...
    private void HandleContext(HttpListenerContext context)
    {
        ...
        RequestReceived?.Invoke(
            new SimpleWebServerRequest(request),
            r =>
            {
...
public class SimpleWebServerRequest : IWebServerRequest
{
    ...
    public SimpleWebServerRequest(HttpListenerRequest request)
    {
        _request = request;
    }
}

public class SimpleWebServerResponse : IWebServerResponse
{
