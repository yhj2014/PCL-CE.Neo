...
public static class McPingServiceFactory
{
    ...
    public static IMcPingService CreateService(IPEndPoint endpoint, int timeout, ILogger<McPingService> logger)
    {
        return new McPingService(endpoint, timeout, logger);
    }

    public static IMcPingService CreateService(string ip, int port, int timeout, ILogger<McPingService> logger)
    {
        return new McPingService(ip, port, timeout, logger);
    }
    ...
    public static IMcPingService CreateLegacyService(IPEndPoint endpoint, int timeout, ILogger<LegacyMcPingService> logger)
    {
        return new LegacyMcPingService(endpoint, timeout, logger);
    }

    public static IMcPingService CreateLegacyService(string ip, int port, int timeout, ILogger<LegacyMcPingService> logger)
    {
        return new LegacyMcPingService(ip, port, timeout, logger);
    }
}