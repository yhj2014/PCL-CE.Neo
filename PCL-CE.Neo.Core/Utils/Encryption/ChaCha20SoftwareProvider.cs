...
public sealed class ChaCha20SoftwareProvider : IEncryptionProvider
{
    ...
    {
        if (data.Length < 12) throw new ArgumentException("Data length is not enough to contain Nonce");
