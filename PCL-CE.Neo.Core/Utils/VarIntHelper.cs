...
/// <summary>
/// VarInt 编码解码工具，用于 Minecraft 协议通信
/// VarInt 使用可变长度编码，节省空间传输整数
/// </summary>
public static class VarIntHelper
{
    ...
    /// <returns>无符号值</returns>
    public static ulong EncodeZigZag(long value) => (ulong)((value << 1) ^ (value >> 63));
}