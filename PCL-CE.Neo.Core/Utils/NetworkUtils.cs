...
{
    private static readonly IPAddress[] LocalIpAddresses = NetworkInterface.GetAllNetworkInterfaces()
    ...
    public static IPAddress[] GetAllLocalAddress() => LocalIpAddresses;
}
